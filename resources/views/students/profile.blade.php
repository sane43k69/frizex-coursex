                    ...
                    <div class="students-info-intro-end">
                        ...
                        <div class="completed-courses">
                            ...
                            <div class="completed-courses-text">
                                ...
                                <p class="fs-6 mt-1">Пройденные курсы</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <nav class="students-info-intro__nav">
                <div class="nav" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab"
                        ...
                        aria-selected="true">Мой профиль</button>

                    <button class="nav-link" id="nav-setting-tab" data-bs-toggle="tab" data-bs-target="#nav-setting"
                        type="button" role="tab" aria-controls="nav-setting" aria-selected="false">Настройки</button>
                </div>
            </nav>
        </div>
                    ...
                    <div class="tab-content__profile">
                        <div class="tab-content__profile-content">
                            <div class="about-student">
                                <h6 class="font-title--card">Обо мне</h6>
                                <p class="font-para--md">
                                    {{$student_info->bio?$student_info->bio:"О студенте"}}
                                </p>
                            </div>
                        </div>
                        <div class="tab-content__profile-content">
                            <div class="info-student">
                                <h6 class="font-title--card">Данные {{ $student_info->name_en }}</h6>
                                ...
                                <dl class="row my-0 info-student-topic">
                                    <dt class="col-sm-4">
                                        <span>Кем является</span>
                                    </dt>
                                    <dd class="col-sm-8">
                                        <p>{{$student_info->profession?$student_info->profession:'Студент'}}</p>
                                    </dd>
                                </dl>
                                <dl class="row my-0 info-student-topic">
                                    <dt class="col-sm-4">
                                    ...
                                    <dd class="col-sm-8">
                                        <p>{{$student_info->contact_en?$student_info->contact_en:'Скрыт'}}</p>
                                    </dd>
                                </dl>
                        ...
                        <div class="col-lg-9 order-2 order-lg-0">
                            <div class="white-bg">
                                <div class="students-info-form">
                                    <h6 class="font-title--card">Твоя информация</h6>
                                    <form action="{{route('student_save_profile')}}" method="post">
                                        @csrf
                                        <div class="row g-3">
                                            <div class="col-lg-6">
                                                <label for="fullName_en">Полное имя</label>
                                                <input type="text" class="form-control" name="fullName_en"
                                                    value="{{$student_info->name_en}}" placeholder="Введите ваше имя" />
                                            </div>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <input type="email" name="emailAddress" class="form-control"
                                                    value="{{$student_info->email}}" placeholder="Введите вашу электронную почту" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <label for="profession">Чем вы занимаетесь?</label>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-lg-6">
                                                <label for="contactNumber_en">Номер телефона</label>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <textarea name="bio" class="form-control" rows="5"
                                                    placeholder="Заполните ячейку о вас">{{$student_info->bio}}</textarea>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-lg-end justify-content-center mt-2">
                                            <button class="button button-lg button--primary" type="submit">Сохранить изменения</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <div class="white-bg mt-4">
                                <div class="students-info-form">
                                    <h6 class="font-title--card">Изменить пароль</h6>
                                    <form action="{{route('change_password')}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
                                                <label for="current_password">Подтвердить пароль</label>
                                    ...
                                    <form id="changeImageForm" action="{{ route('change_image') }}" method="post"
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <button type="button" id="changeImageButton"
                                                class="button button--primary-outline">ИЗМЕНИТЬ ИЗОБРАЖЕНИЕ</button>
                                        </div>
                                    </form>
                                    <p>Размер изображения должен быть менее 1 МБ, соотношение сторон изображения — 200 пикселей..</p>
                                </div>
                            </div>
                        </div>
                    </div>
