        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('event.index')}}">События</a></li>
                    <li class="breadcrumb-item active"><a href="{{route('event.index')}}">Все События</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Весь список событий </h4>
                                <a href="{{route('event.create')}}" class="btn btn-primary">+ Добавить новый</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                <th>{{__('#')}}</th>
                                                <th>{{__('Название события')}}</th>
                                                <th>{{__('Тема')}}</th>
                                                <th>{{__('Тип местоположения')}}</th>
                                                <th>{{__('Дата')}}</th>
                                                <th>{{__('Действие')}}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="6" class="text-center">Событие не найдено</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
