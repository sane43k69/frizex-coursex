...
@section('title', 'Добавления курса')
        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('course.create')}}">Добавление курса</a></li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-xl-12 col-xxl-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Основаная информация</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('course.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="instructorId">
                                            ...
                                            <option value="{{$i->id}}" {{old('instructorId')==$i->id?'selected':''}}>
                                                {{$i->name_en}}</option>
                                            @empty
                                            <option value="">Преподователь не найден</option>
                                            @endforelse
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="courseType">
                                            <option value="free" @if(old('courseType')=='free' ) selected @endif>Бесплатно
                                            </option>
                                            <option value="paid" @if(old('courseType')=='paid' ) selected @endif>Платно
                                            </option>
                                            <option value="subscription" @if(old('courseType')=='subscription' )
                                                selected @endif>На основе подписки</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Начните с</label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="tag">
                                            <option value="popular" @if(old('tag')=='popular' ) selected @endif>Популярный</option>
                                            <option value="featured" @if(old('tag')=='featured' ) selected @endif>Рекомендуемые
                                            </option>
                                            <option value="upcoming" @if(old('tag')=='upcoming' ) selected @endif>Предстоящий
                                            </option>
                                        </select>
                                    </div>
                                </div>
