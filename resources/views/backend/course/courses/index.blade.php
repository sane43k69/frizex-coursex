        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('course.index')}}">Преподаватели</a></li>
                    <li class="breadcrumb-item active"><a href="{{route('course.index')}}">Все курсы</a></li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="row tab-content">
                    <div class="card-header">
                        <a href="{{route('course.create')}}" class="btn btn-primary">+ Добавить новый</a>
                    </div>
                    <div class="col-lg-12">
                        <div class="row">
                            @forelse ($course as $d)
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right border py-0">
                                                <div class="py-2">
                                                    <a class="dropdown-item"
                                                        href="{{route('course.edit', encryptor('encrypt',$d->id))}}">Редактировать</a>
                                                    <a class="dropdown-item text-danger" href="javascript:void(0);"
                                                        onclick="$('#form{{$d->id}}').submit()">Удалить</a>
                                                    <form id="form{{$d->id}}"
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            ...
                                            <ul class="list-group mb-3 list-group-flush">
                                                ...
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">Преподователь :</span>
                                                    <strong>{{$d->instructor?->name_en}}</strong>
                                                </li>
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">Категория :</span>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card card-profile">
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <p class="mt-3 px-4">Курс не найден</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
