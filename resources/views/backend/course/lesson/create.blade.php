        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('lesson.create')}}">Добавить урок курса</a>
                    </li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{route('lesson.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="courseId">
                                            ...
                                            <option value="{{$c->id}}" {{old('courseId')==$c->id?'selected':''}}>
                                                {{$c->title_en}}</option>
                                            @empty
                                            <option value="">Курс не найден</option>
                                            @endforelse
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Конспекты уроков</label>
