        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('courseCategory.index')}}">Категории</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Редактировать категорию</a></li>
                </ol>
            </div>
        </div>
