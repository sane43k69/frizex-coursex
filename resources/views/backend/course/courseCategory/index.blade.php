        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Список категории</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Главная страница</a></li>
                    <li class="breadcrumb-item active"><a href="{{route('courseCategory.index')}}">Категория</a></li>
                    <li class="breadcrumb-item active"><a href="{{route('courseCategory.index')}}">Все категории</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav nav-pills mb-3">
                    ...
                    <li class="nav-item"><a href="#grid-view" data-toggle="tab" class="nav-link btn-primary">Вид
                            Сетки</a></li>
                </ul>
            </div>
            <div class="col-lg-12">
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Полный список категорий </h4>
                                <a href="{{route('courseCategory.create')}}" class="btn btn-primary">+ Добавить новую</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="7" class="text-center">Данная категория не найдена</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                        ...
                        <div class="row">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right border py-0">
                                                <div class="py-2">
                                                    <a class="dropdown-item"
                                                        href="{{route('user.edit', encryptor('encrypt',$d->id))}}">Редактировать</a>
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            ...
                                            <a class="btn btn-outline-primary btn-rounded mt-3 px-4"
                                                href="about-student.html">подробнее</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card card-profile">
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <p class="mt-3 px-4">Категория Не найдена</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
