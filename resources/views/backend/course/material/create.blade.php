...
@section('title', 'Добавить учебные материалы')
        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Добавить учебные материалы</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('material.create')}}">Добавить учебные материалы</a>
                    </li>
                </ol>
            </div>
        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="lessonId">
                                            ...
                                            <option value="{{$l->id}}" {{old('lessonId')==$l->id?'selected':''}}>
                                                {{$l->title}}</option>
                                            @empty
                                            <option value="">Урок не найден</option>
                                            @endforelse
                                        </select>
                                    </div>
