...
@section('title', 'Редактировать материалы курса')
        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Редактировать материалы курса</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Редактировать материалы курса</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{route('material.update',encryptor('encrypt', $material->id))}}" method="post"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="lessonId">
                                            ...
                                            <option value="{{$l->id}}" {{old('lessonId', $material->lesson_id) ==
                                                ...
                                                {{$l->title}}</option>
                                            @empty
                                            <option value="">Урок курса не найден</option>
                                            @endforelse
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">URL-адрес контента</label>
