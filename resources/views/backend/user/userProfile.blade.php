                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="profile-photo">
                                        <img src="{{asset('images\avatar\1.png'.request()->session()->get('image'))}}" class="rounded-circle" height="140" width="140" alt="">
                                    </div>
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="profile-blog pt-3 border-bottom-1 pb-1">
                            ...
                            <img src="{{asset('images\avatar\1.png')}}" alt="" class="img-fluid mt-4 mb-4 w-100">
                        ...
                        <div class="profile-news mt-4 pb-3">
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="{{asset('images\avatar\1.png')}}" alt="image" class="mr-3">
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="{{asset('iimages\avatar\1.png')}}" alt="image" class="mr-3">
                                <div class="media-body">
                                    <h5 class="m-b-5">John Tomas</h5>
                                    <p>I shared this on my fb wall a few months back, and I thought I'd share it here
                                        again because it's such a great read</p>
