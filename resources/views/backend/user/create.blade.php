        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('user.create')}}">Добавить пользователя</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{route('user.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Полный доступ</label>
                                        <select class="form-control" name="fullAccess">
                                            <option value="0" @if(old('fullAccess')==0) selected @endif>Да</option>
                                            <option value="1" @if(old('fullAccess')==1) selected @endif>Нет</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
