        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('user.index')}}">Все пользователи</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Полный список студентов </h4>
                                <a href="{{route('user.create')}}" class="btn btn-primary">+ Добавить нового</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="7" class="text-center">Данный пользователь не найден</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <div class="profile-photo">
                                                <img src="{{asset('images\avatar\1.png'.$d->image)}}" width="100"
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card card-profile">
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <p class="mt-3 px-4">Пользователь не найден</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
