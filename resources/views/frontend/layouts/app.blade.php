...
<head>
    ...
    <title>{{ENV('APP_NAME')}} | @yield('title', 'Главная страница')</title>
...
<body @yield('body-attr')>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse d-none d-xl-block d-none d-xl-block" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{route('home')}}">Главная страница</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{route('searchCourse')}}">Курсы</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{route('about')}}">О нас</a>
                        </li>
                        {{-- <li class="nav-item">
                            <a class="nav-link" href="https://sandra-unkenned-marti.ngrok-free.dev/">
                                События
                            </a>
                        </li> --}}
                        <li class="nav-item">
    ...
    <div class="dropdown user-image ms-3" id="imageDropdown">
        <a href="{{ route('studentdashboard') }}" onclick="toggleDropdown(event)">
            <img src="{{ asset('uploads/students/' . (
    !empty(session('image')) 
    && session('image') !== 'null' 
    && session('image') !== 'No Image Found' 
        ? session('image') 
        : '1.png'
)) }}"
alt="Student Profile"
...
class="rounded-circle border shadow-sm"/>
        ...
        <div class="dropdown-content">
            <a href="{{ route('student_profile') }}">Профиль</a>
            <a href="{{ route('studentdashboard') }}">Личный кабинет</a>
            <a href="{{ route('studentlogOut') }}" class="text-danger">Выйти из аккаунта</a>
        </div>
    </div>
@else
    <a href="{{ route('studentLogin') }}" class="button button--text">Войти</a>
    <a href="{{ route('studentRegister') }}" class="button button--dark">Зарегистрироваться</a>
@endif
                        ...
                        <div class="navbar-mobile__menu">
                            <ul class="navbar-mobile__menu-list">
                                <li class="active navbar-mobile__menu-item">
                                    <a href="{{route('home')}}">
                                        <span class="navbar-mobile__menu-link"> Главная страница</span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="{{route('searchCourse')}}">
                                        <span class="navbar-mobile__menu-link"> Курсы </span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="{{route('about')}}">
                                        <span class="navbar-mobile__menu-link"> О нас </span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="#">
                                        <span class="navbar-mobile__menu-link"> Прочее </span>
                                    ...
                                    <ul class="navbar-mobile__menu-dropmenu">
                                        <li><a href="{{route('searchCourse')}}">Курсы</a></li>
                                        <li><a href="{{route('student_profile')}}">Профиль студента</a></li>
                                ...
                                <li class="navbar-mobile__menu-item">
                                    <a href="{{route('contact')}}">
                                        <span class="navbar-mobile__menu-link"> Контакт </span>
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="footer__wrapper">
                        ...
                        <p>
                           Современная платформа онлайн-обучения для профессионального роста, саморазвития и карьерного успеха.
                        </p>
                    </div>
                </div>
                <div class="col-lg-2 col-sm-4 col-6">
                    <div class="footer__list">
                        ...
                        <ul>
                            ...
                            <li><a href="searchCourse">Курсы</a></li>
                ...
                <div class="col-lg-2 col-sm-4 col-6">
                    <div class="footer__list">
                        <h6>Поддержка</h6>
                        <ul>
                            <li><a href="help-support">Помощь &amp; Поддержка </a></li>
                ...
                <div class="col-lg-2 col-sm-4 col-6">
                    <div class="footer__list">
                        ...
                        <ul>
                            <li><a href="event-search">События</a></li>
                            <li><a href="register">Стать инструктором</a></li>
            ...
            <div class="container">
                <div class="footer__bottom-content">
                    <div class="footer__bottom_copyright">
                        <p>© 2025 - CourseX. Создан Санечкой "inst sane43k69"</p>
                    </div>
