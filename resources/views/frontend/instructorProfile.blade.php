...
@section('title', "Профиль инструктора")
    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0">
                ...
                <li class="breadcrumb-item"><a href="searchCourse" class="fs-6 text-secondary">Курсы</a></li>
                <li class="breadcrumb-item d-none d-lg-inline-block"><a href="#"
                        class="fs-6 text-secondary">Инструктор по курсу</a></li>
...
<section class="section instructor-courses">
    <div class="container">
        <div class="row">
                ...
                <div class="instructor-tabs">
                    <ul class="nav nav-pills instructor-tabs-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-courses-tab" data-bs-toggle="pill"
                                ...
                                aria-selected="true">Курсы</button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-courses" role="tabpanel"
                            ...
                            <div class="row">
            @forelse($instructor->course as $course)
                <div class="col-md-6 mb-4">
                    <div class="contentCard contentCard--course h-100">
                        <div class="contentCard-top">
                            <a href="{{ route('course.details', $course->id) }}">
                                <img src="{{ $course->image ? asset('uploads/courses/'.$course->image) : asset('frontend/dist/images/no-image.png') }}"
                                    alt="{{ $course->title_en }}" class="img-fluid rounded-top" style="height:220px; object-fit:cover;">
                            </a>
                        </div>
                        <div class="contentCard-bottom">
                            <h5>
                                <a href="{{ route('course.details', $course->id) }}" class="font-title--card">
                                    {{ $course->title_en }}
                                </a>
                            </h5>
                            ...
                            <div class="contentCard-info d-flex align-items-center justify-content-between">
                                <div class="contentCard-user d-flex align-items-center">
                                    <img src="{{ $instructor->image ? asset('uploads/instructors/'.$instructor->image) : asset('frontend/dist/images/default-user.png') }}"
                                        alt="{{ $instructor->name }}" class="rounded-circle" width="35" height="35">
                                    <p class="font-para--md ms-2 mb-0">{{ $instructor->name }}</p>
                                </div>
                                <div class="price">
                            ...
                            {{-- при желании можно добавить статистику курса --}}
                            <!-- <div class="contentCard-more d-flex justify-content-between mt-2 text-muted small">
                                <div><i class="fa fa-book me-1"></i>{{ $course->lesson_count }} уроков</div>
                                <div><i class="fa fa-users me-1"></i>{{ $course->enrollment_count }} студентов</div>
                            </div> -->
                        </div>
                    </div>
                </div>
            @empty
                <div class="col-12">
                    <p class="text-muted text-center">Этот инструктор пока не добавил курсы.</p>
                </div>
            @endforelse
        </div>
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <!-- <div class="students-feedback">
                                        <div class="students-feedback-heading">
                                            <h5>Отзывы студентов <span>(0)</span></h5>
                                            <div class="right">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                        <li><button class="dropdown-item" type="button">Рейтинг</button>
                                                        </li>
                                                        <li><button class="dropdown-item" type="button">Другой рейтинг</button></li>
                                    ...
                                    <div class="feedback-comment">
                                        <h6 class="font-title--card">Оставить оценку</h6>
                                        <span>Рейтинг</span>
                                        ...
                                        <form action="#">
                                            ...
                                            <textarea class="form-control" id="comment"
                                                placeholder="Как вы относитесь к инструктору?"></textarea>
                                            <button type="submit"
                                                class="button button-lg button--primary float-end">Пост-обзор</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
