...
<html lang="en">
    <head>
        ...
        <title>Поиск мероприятий-CourseX</title>
        <link rel="stylesheet" href="src/scss/vendors/plugin/css/jquery-ui.css" />
    ...
    <body style="background-color: #ebebf2;" onload="loader()">
                    ...
                    <div class="collapse navbar-collapse d-none d-xl-block" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                ...
                                <div class="nav-item--dropdown">
                                    <ul>
                                        ...
                                        <li><a href='/home-02'>Homepage 02</a></li>
                                        <li><a href='/home-03'>Homepage 03</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="nav-item--dropdown">
                                    <ul>
                                        <li><a href='/course-search'>search course list</a></li>
                                        <li><a href='/course-details'>course details</a></li>
                                        <li><a href='/watch'>Watch Course</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="nav-item--dropdown">
                                    <ul>
                                        <li class="active"><a href='/event-search'>Events Search list</a></li>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="nav-item--subDropdown">
                                                <ul>
                                                    <li><a href='/students-profile'>Students Profile</a></li>
                                        ...
                                        <li><a href='/become-instructor'>Become Instructor</a></li>
                        ...
                        <div class="d-flex align-items-center rightContent rightContent-2">
                            <form action="#" class="header__Search-form" id="searchForm">
                                ...
                                <div id="myOverlay" class="overlay">
                                    <span class="closebtn" onclick="closeSearch()" title="Закрыть окно">×</span>
                            ...
                            <a class='cart-nav border-0 bg-transparent ms-4 me-1' href='/cart'>
                    ...
                    <div class="navbar-mobile">
                        <div>
                            <div class="navbar-mobile__top">
                                <a href='/'> <img src="dist/images/logo/logo.png" alt="brand" class="img-fluid" /> </a>
                                <div>
                            ...
                            <div class="navbar-mobile__menu">
                                <ul class="navbar-mobile__menu-list">
                                    ...
                                    <li class="active navbar-mobile__menu-item">
                                        ...
                                        <ul class="navbar-mobile__menu-dropmenu">
                                            <li><a class='active' href='/event-search'>Events Search list</a></li>
                                            <li><a href='/event'>Event Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="navbar-mobile__menu-item">
            ...
            <div class="container">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb align-items-center bg-transparent p-0 mb-0">
                        <li class="breadcrumb-item"><a class='fs-6 text-secondary' href='/'>Home</a></li>
                        <li class="breadcrumb-item"><a class='fs-6 text-secondary' href='/course-search'>Events</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="event-search-bar">
                            <form action="#">
                                <div class="form-input-group">
                                    <input type="text" class="form-control" placeholder="Поиск событий..." />
                    ...
                    <div class="col-lg-8">
                        <div class="event-search-results">
                            <div class="event-search-results-heading">
                                ...
                                <p>1, 254 найденные результаты.</p>
                        ...
                        <div class="row event-search-content">
                            <div class="col-md-6 mb-4">
                                <div class="contentCard contentCard--event">
                                    <div class="contentCard-top">
                                        <a href='/event'><img src="dist/images/courses/demo-img-01.png" alt="images" class="img-fluid" /></a>
                                    </div>
                                    <div class="contentCard-bottom">
                                        <h5>
                                            <a class='font-title--card' href='/event'>Chicago International Conference on Education</a>
                                        </h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="contentCard contentCard--event">
                                    <div class="contentCard-top">
                                        <a href='/event'><img src="dist/images/courses/demo-img-02.png" alt="images" class="img-fluid" /></a>
                                    </div>
                                    <div class="contentCard-bottom">
                                        <h5>
                                            <a class='font-title--card' href='/event'>Chicago International Conference on Education</a>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="contentCard contentCard--event">
                                    <div class="contentCard-top">
                                        <a href='/event'><img src="dist/images/courses/demo-img-03.png" alt="images" class="img-fluid" /></a>
                                    </div>
                                    <div class="contentCard-bottom">
                                        <h5>
                                            <a class='font-title--card' href='/event'>Chicago International Conference on Education</a>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="contentCard contentCard--event">
                                    <div class="contentCard-top">
                                        <a href='/event'><img src="dist/images/courses/demo-img-04.png" alt="images" class="img-fluid" /></a>
                                    </div>
                                    <div class="contentCard-bottom">
                                        <h5>
                                            <a class='font-title--card' href='/event'>Chicago International Conference on Education</a>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="contentCard contentCard--event">
                                    <div class="contentCard-top">
                                        <a href='/event'><img src="dist/images/courses/demo-img-05.png" alt="images" class="img-fluid" /></a>
                                    </div>
                                    <div class="contentCard-bottom">
                                        <h5>
                                            <a class='font-title--card' href='/event'>Chicago International Conference on Education</a>
                        ...
                        <div class="pagination-group my-4">
                            <a href="#" class="p_prev">
                    ...
                    <div class="col-lg-2 col-sm-4 col-6">
                        <div class="footer__list">
                            ...
                            <ul>
                                ...
                                <li><a href='/become-instructor'>Become a Instructor</a></li>
                ...
                <div class="container">
                    <div class="footer__bottom-content">
                        <div class="footer__bottom_copyright">
                            <p>© 2021 - CourseX. All rights reserved</p>
                        </div>
        ...
        <script src="src/scss/vendors/plugin/js/price_range_script.js"></script>
        <script src="src/scss/vendors/plugin/js/jquery-ui.min.js"></script>
        ...
        <div class="templatecookie-btn">
            <a href="https://1.envato.market/P0Ar3Y" target="_blank" class="purchase-btn">
                Purchase Now
                <span>
