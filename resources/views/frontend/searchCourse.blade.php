    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center bg-transparent p-0 mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="searchCourse" class="fs-6 text-secondary">Курсы</a>
                </li>
            </ol>
        </nav>
    </div>
...
<section class="section event-search">
    ...
    <div class="col-lg-9 mx-auto">
        <div class="event-search-bar">
            <form action="{{ route('courses.search') }}" method="GET" class="position-relative">
                <div class="form-input-group position-relative">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" 
                        ...
                        class="feather feather-search position-absolute top-50 start-0 translate-middle-y ms-3 text-muted">
                    ...
                    <!-- Кнопка -->
                    <button 
                        class="button button-lg button--primary position-absolute top-50 end-0 translate-middle-y me-2" 
                        type="submit" 
                        id="button-addon2">
                        Поиск
                    </button>
                                    ...
                                    <div>
                                        <div class="price-range-block">
                                            <form class="d-flex price-range-block__inputWrapper" action="#">
                                                ...
                                                <span>к</span>
                                                <input type="number" min="0" max="1000000"
                                                    oninput="validity.valid||(value='1000000');" id="max_price"
                                                    class="price-range-field"
                ...
                <div class="event-search-results">
                    <div class="event-search-results-heading">
                        <div class="nice-select" tabindex="0">
                            <span class="current">Самые просматриваемые</span>
                            <ul class="list">
                                <li data-value="Nothing" data-display="Категории" class="option selected focus">
                                    Категории
                                </li>
                                <li data-value="1" class="option">По цене</li>
                                <li data-value="2" class="option">По отзывам</li>                               
                            </ul>
                        </div>
                        <p>{{$course->count()}} найденные результаты.</p>
...
<div class="contentCard-bottom">
    ...
    @php
        // Используем ID курса как "seed" для стабильного рандома
        mt_srand($c->id);
        $rating = number_format(mt_rand(43, 49) / 10, 1); // рейтинг 4.3–4.9
        $views = mt_rand(500, 25000); // просмотры
        $students = mt_rand(50, 5000); // количество студентов
    @endphp
    ...
    <div class="contentCard-more">
        ...
        <div class="book d-flex align-items-center">
            <div class="icon">
                <img src="{{ asset('frontend/dist/images/icon/book.png') }}" alt="book" />
            </div>
