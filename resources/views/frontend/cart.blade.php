    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center bg-transparent mb-0">
                ...
                <li class="breadcrumb-item active"><a href="cart.html" class="fs-6 text-secondary">Корзина</a></li>
            </ol>
        </nav>
    </div>
</div>
...
<section class="section cart-area pb-0">
        ...
        @foreach (session('cart') as $id => $details)
            ...
            <div class="cart-wizard-area">
                ...
                <div class="text">
                    ...
                    <p>От <a href="#">{{ $details['instructor'] }}</a></p>
    ...
    @endif
            ...
            <div class="col-lg-4">
                <h6 class="cart-area__label">Итоговая информация</h6>
                <div class="summery-wizard">
                    ...
                    <div class="summery-wizard-text">
                        <h6>Скидка по купону ({{session('cart_details')['discount'] ?? 0.00}}%)</h6>
                    ...
                    <div class="total-wizard">
                        <h6 class="font-title--card">Итог:</h6>
                    ...
                    <form action="{{route('coupon_check')}}" method="post">
                        ...
                        <a href="{{route('checkout')}}"
                            class="button button-lg button--primary form-control mb-lg-3">Оформление заказа</a>
                        <label for="coupon">Использовать купон</label>
                        <div class="cart-input">
                            <input type="text" name="coupon" class="form-control" placeholder="Промокод" id="coupon" />
                            <button type="submit" class="sm-button">Использовать</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <section class="section cart-area pb-0">
            <div class="container text-center">
                ...
                <h5>В вашей корзине пока нет курсов</h5>
            </div>
        </section>
        @endif
    </div>
